          ...
          <div className="flex gap-4 pt-2">
            {[
              ...
              <a 
                ...
                className="w-11 h-11 rounded-lg border border-white/10 flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all shadow-lg"
              >
                <soc.icon size={20} />
              </a>
            ))}
          ...
          <ul className="space-y-4 text-muted-foreground text-sm font-medium">
             ...
             <li>
                <Dialog>
                  ...
                  <DialogContent className="max-w-2xl max-h-[85vh] rounded-lg border-white/10 bg-card p-10 shadow-2xl z-[80]">
